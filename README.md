...
| `generatr.mermiad.customInit            | URL to hosted custom JS or path to custom JS file (location relative to the configured `assets` folder). When configured this JS module needs to provide an single function as a default export. It will be called with mermaid module as its sole argument.                                                                                     |                                | `site/init.mjs` or `https://uri.example/init.mjs`    |
