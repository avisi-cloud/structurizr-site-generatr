...
dependencies {
    ...
    implementation("com.structurizr:structurizr-core:4.0.0")
    implementation("com.structurizr:structurizr-dsl:4.0.0")
    implementation("com.structurizr:structurizr-export:4.0.0")
    ...
    implementation("org.eclipse.jetty.websocket:jetty-websocket-jetty-server:12.0.18")
