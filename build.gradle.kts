...
dependencies {
    ...
    implementation("com.structurizr:structurizr-core:6.2.2")
    implementation("com.structurizr:structurizr-dsl:6.2.2")
    implementation("com.structurizr:structurizr-export:6.2.2")

    implementation("net.sourceforge.plantuml:plantuml:1.2026.7")
    ...
    implementation("org.eclipse.jetty.websocket:jetty-websocket-jetty-server:12.1.12")
    ...
    runtimeOnly("org.jruby:jruby-core:9.4.15.0")
