...
dependencies {
    ...
    implementation("com.structurizr:structurizr-core:5.0.2")
    implementation("com.structurizr:structurizr-dsl:5.0.2")
    implementation("com.structurizr:structurizr-export:5.0.2")
