...
dependencies {
    ...
    implementation("com.structurizr:structurizr-core:1.20.1")
    implementation("com.structurizr:structurizr-dsl:1.26.1")
    implementation("com.structurizr:structurizr-export:1.10.0")
