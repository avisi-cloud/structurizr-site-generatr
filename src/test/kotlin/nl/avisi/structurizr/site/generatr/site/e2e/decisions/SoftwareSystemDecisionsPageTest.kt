...
class SoftwareSystemDecisionsPageTest : E2ETestFixture() {
    ...
    fun `component decision tabs render correctly`() {
        decisionPageTestHelper.testComponentDecisionTabs(page) { _, data ->
    ...
    fun `decisions table renders correctly`() {
        decisionPageTestHelper.testDecisionsTable(page) { data ->
            ...
            assertThat(data[0]).isEqualTo(listOf("1", "21-06-2022", "Accepted", "Record Internet Banking System architecture decisions"))
        }
    }
}
